...
#     id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), primary_key=True, index=True,
#                                           default=uuid.uuid4)
#     first_name: Mapped[str] = mapped_column(String(260), nullable=False) #delete?
#     middle_name: Mapped[str] = mapped_column(String(260), nullable=False)#delete?
#     family_name: Mapped[str] = mapped_column(String(260), nullable=False)#delete?
#     profile_picture: Mapped[str] = mapped_column(String(400), nullable=False)
...
#     active: Mapped[bool] = mapped_column(Boolean)
#     registered_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=tashkent_now) #delete?
...
#     registered_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=tashkent_now) # останется
...
#     phone_number: Mapped[str] = mapped_column(String(90), nullable=False)
#     school: Mapped[int] = mapped_column(ForeignKey('schools.id'), nullable=False, index=True)
#     registered_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=tashkent_now) # delete the field?
#     active: Mapped[bool] = mapped_column(Boolean)
